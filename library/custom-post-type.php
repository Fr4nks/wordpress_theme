...
function custom_post_example() { 
	...
	register_post_type( 'custom_type', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		...
		array('labels' => array(
			'name' => __('Journals', 'bonestheme'), /* This is the Title of the Group */
			'singular_name' => __('Journal', 'bonestheme'), /* This is the individual type */
			'all_items' => __('All Journal', 'bonestheme'), /* the all items menu item */
			'add_new' => __('Add New', 'bonestheme'), /* The add new menu item */
			'add_new_item' => __('Add New Journal', 'bonestheme'), /* Add New Display Title */
